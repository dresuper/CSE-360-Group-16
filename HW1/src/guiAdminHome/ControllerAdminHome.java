...
public class ControllerAdminHome {
	...
	*/
	 ...
	 * this function has not yet been implemented. </p>
	 */
	protected static void suspendUser() {
		String user = ViewAdminHome.text_InvitationEmailAddress.getText().trim();
		if (user.isEmpty()) {
			ViewAdminHome.alertEmailError.setContentText("Enter a username:");
					ViewAdminHome.alertEmailError.showAndWait();
					return;
		}
		
		
		boolean suspendOn = theDatabase.userSuspend2(user);
		boolean updated = theDatabase.userSuspend(user, !suspendOn);
