...
public class ViewAdminHome {
	...
	*/
	...
	protected static Button button_SuspendUser = new Button("Suspend a User");
	...
	*/
	...
	private ViewAdminHome() {
		...
		setupButtonUI(button_SuspendUser, "Dialog", 16, 250, Pos.CENTER, 290, 470);
		button_SuspendUser.setOnAction((event) -> {ControllerAdminHome.suspendUser(); });
