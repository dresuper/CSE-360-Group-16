...
public class ViewUserLogin {
	...
	private static Button button_Forgot = new Button("Forgot Password?");	
	private static Button button_Reset = new Button("Get reset code");	
	...
	private ViewUserLogin() {
		...
		setupButtonUI(button_Forgot, "Dialog", 14, 200, Pos.CENTER, 475, 240);
		button_Forgot.setOnAction((event) -> {
		    ControllerUserLogin.onForgotPassword();
		});
		...
		theRootPane.getChildren().addAll(
				...
				button_Login, text_Password, button_Forgot, button_Reset, text_Invitation, button_SetupAccount,
				button_Quit);
	}
